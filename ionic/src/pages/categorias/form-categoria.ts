...
export class FormCategoriasPage {
    ...
    private categoriaTemp:any = {idCategoria:0 , nombreCa: ""}
  ...
  public nuevaCat(){
      this._categoria.insertCategoria(this.categoriaTemp.nombreCa, (res)=>{
        this.toast.create({
  ...
  public deleteCat(){ 
    let prompt = this.alertCtrl.create({
      title: 'Eliminar',
      message: `¿Desea eliminar la categoria ${this.categoriaTemp.nombreCa}?` ,
      buttons: [
        {
          text: 'Cancelar',
          handler: data => {
